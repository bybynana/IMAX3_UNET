...
#if CONV_SELECT == 1
#define IN_PATH "cnn3d_bins/Conv1_input.bin"
#define KER_PATH "cnn3d_bins/Conv1_kernel.bin"
...
#if CONV_SELECT == 2
#define IN_PATH "cnn3d_bins/Conv2_input.bin"
#define KER_PATH "cnn3d_bins/Conv2_kernel.bin"
...
#if CONV_SELECT == 3
#define IN_PATH "cnn3d_bins/Conv3_input.bin"
#define KER_PATH "cnn3d_bins/Conv3_kernel.bin"
...
#if CONV_SELECT == 4
#define IN_PATH "cnn3d_bins/Conv4_input.bin"
#define KER_PATH "cnn3d_bins/Conv4_kernel.bin"
...
#if CONV_SELECT == 5
#define IN_PATH "cnn3d_bins/Conv5_input.bin"
#define KER_PATH "cnn3d_bins/Conv5_kernel.bin"
...
#if CONV_SELECT == 6
#define IN_PATH "cnn3d_bins/Bottleneck_input.bin"
#define KER_PATH "cnn3d_bins/Bottleneck_kernel.bin"
...
#if CONV_SELECT == 7
#define IN_PATH "cnn3d_bins/UpConv4_input.bin"
#define KER_PATH "cnn3d_bins/UpConv4_kernel.bin"
...
#if CONV_SELECT == 8
#define IN_PATH "cnn3d_bins/UpConv3_input.bin"
#define KER_PATH "cnn3d_bins/UpConv3_kernel.bin"
...
#if CONV_SELECT == 9
#define IN_PATH "cnn3d_bins/UpConv2_input.bin"
#define KER_PATH "cnn3d_bins/UpConv2_kernel.bin"
...
#if CONV_SELECT == 10
#define IN_PATH "cnn3d_bins/UpConv1_input.bin"
#define KER_PATH "cnn3d_bins/UpConv1_kernel.bin"
...
#if CONV_SELECT == 11
#define IN_PATH "cnn3d_bins/UpConv0_input.bin"
#define KER_PATH "cnn3d_bins/UpConv0_kernel.bin"
...
#define cnn_final(r, rp1, Force) \
            mop(OP_LDR,  1, &BR[rp1][0][1],  (Ull)op0[CHIP], oofs, MSK_W0, (Ull)ot0[CHIP], W*RMGRP, 0, Force, (Ull)NULL, W*RMGRP);\
            mop(OP_LDR,  1, &BR[rp1][1][1],  (Ull)op1[CHIP], oofs, MSK_W0, (Ull)ot1[CHIP], W*RMGRP, 0, Force, (Ull)NULL, W*RMGRP);\
            mop(OP_LDR,  1, &BR[rp1][2][1],  (Ull)op2[CHIP], oofs, MSK_W0, (Ull)ot2[CHIP], W*RMGRP, 0, Force, (Ull)NULL, W*RMGRP);\
            mop(OP_LDR,  1, &BR[rp1][3][1],  (Ull)op3[CHIP], oofs, MSK_W0, (Ull)ot3[CHIP], W*RMGRP, 0, Force, (Ull)NULL, W*RMGRP);\
            exe(OP_FAD, &AR[rp1][0], AR[r][0], EXP_H3210, BR[rp1][0][1], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);\
            exe(OP_FAD, &AR[rp1][1], AR[r][1], EXP_H3210, BR[rp1][1][1], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);\
            exe(OP_FAD, &AR[rp1][2], AR[r][2], EXP_H3210, BR[rp1][2][1], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);\
            exe(OP_FAD, &AR[rp1][3], AR[r][3], EXP_H3210, BR[rp1][3][1], EXP_H3210, 0LL, EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);\
            mop(OP_STR,  3, &AR[rp1][0], oofs, (Ull)op0[CHIP], MSK_D0, (Ull)ot0[CHIP], W*RMGRP, 0, Force, (Ull)NULL, W*RMGRP);\
            mop(OP_STR,  3, &AR[rp1][1], oofs, (Ull)op1[CHIP], MSK_D0, (Ull)ot1[CHIP], W*RMGRP, 0, Force, (Ull)NULL, W*RMGRP);\
            mop(OP_STR,  3, &AR[rp1][2], oofs, (Ull)op2[CHIP], MSK_D0, (Ull)ot2[CHIP], W*RMGRP, 0, Force, (Ull)NULL, W*RMGRP);\
            mop(OP_STR,  3, &AR[rp1][3], oofs, (Ull)op3[CHIP], MSK_D0, (Ull)ot3[CHIP], W*RMGRP, 0, Force, (Ull)NULL, W*RMGRP)
//EMAX5A begin cnn mapdist=0
    /*3*/ for (CHIP=0; CHIP<NCHIP; CHIP++) { /* output channels are parallelized by multi-chip (OC/#chip) */
