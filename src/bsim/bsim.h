...
/* (*default_conf)  DeepROB   MS   GPU   Phi  EMAX5              */
...
/*¡ú¡ú¡ú ARM:2.4GHz   EMAX5:300MHz  */
#define ARM_EMAX5_RATIO 8
/*¡ú¡ú¡ú ARM:50cycle EMAX5:6cycle */
#define L2DIRDL         50
/*¡ú¡ú¡ú ARM:100cycle EMAX5:12cycle */
#define CCDELAY         100
/*¡ú¡ú¡ú ARM:150cycle EMAX5:18cycle */
#define MMDELAY         150
...
#define ALOCLIMIT       0x4dbfff00              /* global variables:1.5GB        */
#define STACKPERTHREAD  0x00010000              /* stack/thread:64KB(0x10000)    */
#define STACKINIT       0x4fbfff00              /* MAXTHRD:1-512 STACK:0x02000000 */
#define ACP_BASE2_PHYS	0x4fc00000              /* keep same as in emax5lib.h    */
...
struct t {
  ...
  Ull      emax5_gr1;
  Ull      emax5_gr2;
  int      emax5_mode;        /* 1:normal_array, 2:drain_dirty_lmm */
...
union armf {
  ...
  struct fcvt_sca { /* C7.3.57 FCVT(scalar) */
    Uint   rd      : 5;
    Uint   rn      : 5;
    Uint   op14_10 : 5;
    Uint   opc     : 2;
