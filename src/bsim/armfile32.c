...
static char RcsHeader[] = "$Header: /usr/home/nakashim/proj-arm64/src/bsim/RCS/armfile32.c,v 1.3 2017/02/25 06:32:54 nakashim Exp nakashim $";
...
/* WRITE_AOUT() */
  ...
  *(int*)memp = Ahead.a_entry+Ahead.a_text+Ahead.a_data;
