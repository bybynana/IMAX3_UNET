...
static char RcsHeader[] = "$Header: /usr/home/nakashim/proj-arm64/src/bsim/RCS/armfile64.c,v 1.3 2017/02/25 06:32:54 nakashim Exp nakashim $";
...
/* WRITE_AOUT() */
  ...
  *(Ull*)memp = Ahead.a_entry+Ahead.a_text+Ahead.a_data;
