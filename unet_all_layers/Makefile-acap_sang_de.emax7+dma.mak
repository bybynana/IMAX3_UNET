...
PROGRAM       = cnn3d-acap_sang_de.emax7+dma
CPP           = cpp -P
CC            = gcc
CFLAGS        = -I. -O2 $(OPTION)
AS            = as
...
SRCS	      =	cnn3d+rmm_sang_de.c

all:		$(PROGRAM)

clean:;		rm -f *.o core *~ *-mark.c *-cppo.c *-emax7.c *-emax7s?.c

cnn3d-acap_sang_de.emax7+dma: cnn3d+rmm_sang_de-emax7.o
		$(CC) $(LDFLAGS) -o $@ $< $(LIBFLAGS) $(LIBS)

cnn3d+rmm_sang_de-emax7.o:	cnn3d+rmm_sang_de-emax7.c
		$(CC) $(CFLAGS) -w -c $<

cnn3d+rmm_sang_de-emax7.c:	cnn3d+rmm_sang_de.c
